      ...
      <div className="h-[450px]">
        <ResponsiveContainer width="100%" height={450}>
          <BarChart data={boxData} layout="vertical" margin={{ left: 10, right: 30, bottom: 10 }}>
                ...
                if (active && payload && payload.length) {
                  ...
                  return (
                    <div className="bg-white p-3 border rounded-lg shadow-lg text-sm">
                      ...
                      <p className="text-blue-600">Min: {data.low} miles</p>
                      <p className="text-green-600">Max: {(data.low + data.range).toFixed(1)} miles</p>
                      <p className="text-orange-600 font-bold">Trung bình: {data.avg} miles</p>
                    </div>
                  );
                }
                return null;
            ...
            <Bar dataKey="range" stackId="a" fill="#6366f1" radius={[0, 4, 4, 0]} barSize={24} />
          </BarChart>
        </ResponsiveContainer>
      </div>
